...
# ---------------------------------------------------------------------------
# Phase 3b: BOQ Templates -> pindah ke routes/boq_templates.py (2026-09-17).
# Router-nya di-mount di app.py SEBELUM boq_router agar path
# /api/boq/templates* tidak di-match /api/boq/{bid}.
# ---------------------------------------------------------------------------
